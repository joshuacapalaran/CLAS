          ...
          <?php foreach ($schedules as $schedule): ?>
            <div class="row">
              <div class="col-6 offset-3">
                <h5><?=$schedule['subject_code'] . ' ' . $schedule['subject_name']?></h5>
              </div>
            </div>
            <div class="row">
              <div class="col-6 offset-3">
                <form class="" action="<?=base_url()?>/schedules/timein" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-success">Time in / Time out</button>
                  </div>
                </form>
              </div>
            </div>
