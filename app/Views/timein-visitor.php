    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                    ...
                    <h5 class="h5 mb-0 text-gray-800"><a href="<?=base_url();?>/visitors"> List of Visitors</a> > Log in</h5>
                    <!-- data -->
                 <div class="card shadow mb-4">
                      ...
                      <div class="container">
                            ...
                            <div class="row">
                            <div class="col-md-9">
                            <form action="<?php echo base_url('visitors/store_time_in');?>" name="visitor_form" id="visitor_form" method="visitor" accept-charset="utf-8">

                              <div class="form-group">
                                <label for="visitor_name">Name</label>
                                <input type="text" name="visitor_name" class="form-control" id="visitor_name" placeholder="Please enter your name" required>

                              </div>

                              <div class="form-group">
                                <label for="visitor_purpose">Purpose</label>
                                <input type="text" name="visitor_purpose" class="form-control" id="visitor_purpose" placeholder="Please enter your purpose" required>
