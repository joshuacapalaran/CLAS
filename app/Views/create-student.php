            ...
            <div id="content">
                ...
                <div class="container-fluid">
                 ...
                 <div class="card shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                        <form action="<?php echo base_url('students/store');?>" name="student_form" id="student_form" method="student" accept-charset="utf-8">
                            ...
                            <div class="form-group">
                            <label for="m_initial">Middle Intial</label>
                            <input type="text" name="m_initial" class="form-control" id="m_initial" placeholder="Middle Initial" required>
                            ...
                            <input type="number" name="pcnum" class="form-control" id="pcnum" placeholder="PC Number">
