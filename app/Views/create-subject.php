        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="h5 mb-0 text-gray-800"><a href="<?=base_url();?>/subjects"> List of Subjects</a> > Add Subject</h5>
                    <!-- data -->
                   <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                            <div class="col-md-9">
                                <form action="<?php echo base_url('subjects/store');?>" name="subject_form" id="subject_form" method="subject" accept-charset="utf-8">

                                <div class="form-group">
                                    <label for="subject_code">Subject Code</label>
                                    <input type="text" name="subject_code" class="form-control" id="subject_code" placeholder="Please enter subject code" required>

                                </div>

                                <div class="form-group">
                                    <label for="subject_name">Subject Name</label>
                                    <input type="text" name="subject_name" class="form-control" id="subject_name" placeholder="Please enter subject name" required>
