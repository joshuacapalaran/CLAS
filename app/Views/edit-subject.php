        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="h5 mb-0 text-gray-800"><a href="<?=base_url();?>/subjects"> List of Subjects</a> > Edit Subject</h5>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                          ...
                          <div class="row">
                            <div class="col-md-9">
                              <form action="<?php echo base_url('subjects/update');?>" name="subject_form" id="subject_form" method="subject" accept-charset="utf-8">

                                <input type="hidden" name="id" class="form-control" id="id" value="<?php echo $subject['id'] ?>">


                                <div class="form-group">
                                  <label for="subject_code">Subject Code</label>
                                  <input type="text" name="subject_code" class="form-control" id="subject_code" placeholder="Please enter subject_code" value="<?php echo $subject['subject_code'] ?>">

                                </div>

                                <div class="form-group">
                                  <label for="subject_name">Subject Name</label>
                                  <input type="text" name="subject_name" class="form-control" id="subject_name" placeholder="Please enter subject_name" value="<?php echo $subject['subject_name'] ?>">
