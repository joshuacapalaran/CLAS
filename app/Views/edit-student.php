        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="h5 mb-0 text-gray-800"><a href="<?=base_url();?>/students"> List of Students</a> > Edit Student</h5>
                    ...
                    <!-- data -->
                     <div class="card shadow mb-4">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                <div class="col-md-9">
                                    <form action="<?php echo base_url('students/update');?>" name="student_form" id="student_form" method="student" accept-charset="utf-8">

                                    <input type="hidden" name="id" class="form-control" id="id" value="<?php echo $student['id'] ?>">

                                    <div class="form-group">
                                        <label for="studentnumber">Student Number</label>
                                        <input type="text" name="studentnumber" class="form-control" id="studentnumber" placeholder="Please enter student number" value="<?php echo $student['studentnumber'] ?>">

                                    </div>

                                    <div class="form-group">
                                        <label for="lastname">Lastname</label>
                                        <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Please enter lastname" value="<?php echo $student['lastname'] ?>">

                                    </div>

                                    <div class="form-group">
                                        <label for="firstname">Firstname</label>
                                        <input type="text" name="firstname" class="form-control" id="firstname" placeholder="Please enter firstname" value="<?php echo $student['firstname'] ?>">

                                    </div>

                                    <div class="form-group">
                                        <label for="m_initial">Middle Initial</label>
                                        <input type="text" name="m_initial" class="form-control" id="m_initial" placeholder="Please enter middle initial" value="<?php echo $student['m_initial'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value='I - 1' <?= $student['year'] == 'I - 1'?'selected':'';?>>I - 1</option>
                                        <option value='II - 1' <?= $student['year'] == 'II - 1'?'selected':'';?>>II - 1</option>
                                        <option value='III - 1' <?= $student['year'] == 'III - 1'?'selected':'';?>>III - 1</option>
                                        <option value='IV - 1' <?= $student['year'] == 'IV - 1'?'selected':'';?>>IV - 1</option>
                                        <option value='IV - 1' <?= $student['year'] == 'IV - 1'?'selected':'';?>>V - 1</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="pcnum" class="form-control" id="pcnum" placeholder="Please enter pc number" value="<?php echo $student['pcnum'] ?>">
