        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="h5 mb-0 text-gray-800"><a href="<?=base_url();?>/courses"> List of Courses</a> > Add Courses</h5>
                    <!-- data -->
                   <div class="card shadow mb-4">
                      ...
                      <div class="container">
                          ...
                          <div class="row">
                            <div class="col-md-9">
                              <form action="<?php echo base_url('courses/store');?>" name="course_form" id="course_form" method="course" accept-charset="utf-8">

                                <div class="form-group">
                                  <label for="course">Course</label>
                                  <input type="text" name="course" class="form-control" id="course" placeholder="Please enter course" required>
