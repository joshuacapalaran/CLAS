    ...
    <div id="wrapper">
                        ...
                        <div class="card shadow mb-4">
                          <div class="card-header py-3" >
                              <h6 class="m-0 font-weight-bold text-primary">
                                  <a href="<?php echo base_url('schedules/create') ?>" class="btn btn-sm btn-success">Create</a>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <!-- <a href="<?php echo base_url('schedules/create') ?>" class="btn btn-sm btn-success">Create</a> -->
          <!-- <div class="row mt-3"> -->
               <table class="table table-bordered" id="schedules" width="100%" cellspacing="0">
               <thead>
               ...
               <tbody>
                ...
                <tr class="text-center">
                     <td><?php echo $schedule['subject_code']." ".$schedule['subject_name']; ?></td>
                     <td><?php echo $schedule['course']; ?></td>
                     <!-- <td><?php echo 'year and section' ?></td> -->
                     <td><?php echo $schedule['start_time']; ?></td>
                     <td><?php echo $schedule['end_time']; ?></td>
                     <td><?php echo $schedule['date_sched']; ?></td>
                     <td><?php echo $schedule['lab_used']; ?></td>
                     <td><?php echo $schedule['faculty_name']; ?></td>
                     <!-- <td><?php echo 'remarks' ?></td> -->
                     <td><?php echo $schedule['semester']; ?></td>
                     <td><?php echo $schedule['school_year']; ?></td>
                     <td>
                      <a href="<?php echo base_url('schedules/attendance/'.$schedule['id']);?>" class="btn btn-sm btn-success">Attendance</a>
                      <!-- <a href="<?php echo base_url('schedules/edit/'.$schedule['id']);?>" class="btn btn-sm btn-success">Edit</a> -->
                      <a href="<?php echo base_url('schedules/delete/'.$schedule['id']);?>" class="btn btn-sm btn-danger">Delete</a>
                      </td>
                  </tr>
                 <?php endforeach; ?>
                 <?php endif; ?>
